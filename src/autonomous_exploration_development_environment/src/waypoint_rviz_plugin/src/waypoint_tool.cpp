...
{
  sub_ = nh_.subscribe<nav_msgs::Odometry> ("/ugv/state_estimation", 5, &WaypointTool::odomHandler, this);
  pub_ = nh_.advertise<geometry_msgs::PointStamped>("/ugv/way_point", 5);
  pub_joy_ = nh_.advertise<sensor_msgs::Joy>("/ugv/joy", 5);
}
