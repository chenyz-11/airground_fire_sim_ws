...
{
  sub_ = nh_.subscribe<nav_msgs::Odometry> ("/uav/state_estimation", 5, &WaypointTool::odomHandler, this);
  pub_ = nh_.advertise<geometry_msgs::PointStamped>("/uav/way_point", 5);
  pub_joy_ = nh_.advertise<sensor_msgs::Joy>("/uav/joy", 5);
}
