...
int main(int argc, char** argv)
{
  ...
  ros::Subscriber subPose = nh.subscribe<nav_msgs::Odometry> ("/uav/state_estimation", 5, poseHandler);
  ...
  ros::Publisher pubSpeed = nh.advertise<std_msgs::Float32> ("/uav/speed", 5);
