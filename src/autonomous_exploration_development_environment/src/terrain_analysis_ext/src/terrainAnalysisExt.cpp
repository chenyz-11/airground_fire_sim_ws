...
int main(int argc, char** argv)
{
  ...
  ros::Subscriber subClearing = nh.subscribe<std_msgs::Float32>("/ugv/cloud_clearing", 5, clearingHandler);

  ros::Subscriber subTerrainCloudLocal = nh.subscribe<sensor_msgs::PointCloud2>("/ugv/terrain_map", 2, terrainCloudLocalHandler);

  ros::Publisher pubTerrainCloud = nh.advertise<sensor_msgs::PointCloud2>("/ugv/terrain_map_ext", 2);
