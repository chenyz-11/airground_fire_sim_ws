...
bool PlannerParameters::ReadParameters(ros::NodeHandle& nh)
{
  ...
  sub_state_estimation_topic_ =
      misc_utils_ns::getParam<std::string>(nh, "sub_state_estimation_topic_", "/ugv/state_estimation_at_scan");
  sub_registered_scan_topic_ =
      misc_utils_ns::getParam<std::string>(nh, "sub_registered_scan_topic_", "/ugv/registered_scan");
  sub_terrain_map_topic_ = misc_utils_ns::getParam<std::string>(nh, "sub_terrain_map_topic_", "/ugv/terrain_map");
  sub_terrain_map_ext_topic_ =
      misc_utils_ns::getParam<std::string>(nh, "sub_terrain_map_ext_topic_", "/ugv/terrain_map_ext");
  ...
  sub_viewpoint_boundary_topic_ =
      misc_utils_ns::getParam<std::string>(nh, "sub_viewpoint_boundary_topic_", "/ugv/navigation_boundary");
  sub_nogo_boundary_topic_ = misc_utils_ns::getParam<std::string>(nh, "sub_nogo_boundary_topic_", "/nogo_boundary");
  sub_joystick_topic_ = misc_utils_ns::getParam<std::string>(nh, "sub_joystick_topic_", "/ugv/joy");
  ...
  pub_runtime_topic_ = misc_utils_ns::getParam<std::string>(nh, "pub_runtime_topic_", "/ugv/runtime");
  pub_waypoint_topic_ = misc_utils_ns::getParam<std::string>(nh, "pub_waypoint_topic_", "/ugv/way_point");
...
bool SensorCoveragePlanner3D::initialize(ros::NodeHandle& nh, ros::NodeHandle& nh_p)
{
  ...
  global_path_full_publisher_ = nh.advertise<nav_msgs::Path>("/ugv/sensor_coverage_planner/global_path_full", 1);
  global_path_publisher_ = nh.advertise<nav_msgs::Path>("/ugv/sensor_coverage_planner/global_path", 1);
  old_global_path_publisher_ = nh.advertise<nav_msgs::Path>("/ugv/sensor_coverage_planner/old_global_path", 1);
  to_nearest_global_subspace_path_publisher_ =
      nh.advertise<nav_msgs::Path>("/ugv/sensor_coverage_planner/to_nearest_global_subspace_path", 1);
  local_tsp_path_publisher_ = nh.advertise<nav_msgs::Path>("/ugv/sensor_coverage_planner/local_path", 1);
  exploration_path_publisher_ = nh.advertise<nav_msgs::Path>("/ugv/sensor_coverage_planner/exploration_path", 1);
