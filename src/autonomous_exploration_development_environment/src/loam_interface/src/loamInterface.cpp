...
int main(int argc, char** argv)
{
  ...
  ros::Publisher pubOdometry = nh.advertise<nav_msgs::Odometry> ("/ugv/state_estimation", 5);
  pubOdometryPointer = &pubOdometry;

  tf::TransformBroadcaster tfBroadcaster;
  tfBroadcasterPointer = &tfBroadcaster;

  ros::Publisher pubLaserCloud = nh.advertise<sensor_msgs::PointCloud2> ("/ugv/registered_scan", 5);
