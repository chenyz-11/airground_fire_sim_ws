...
def listener():
  ...
  rospy.Subscriber("/ugv/time_duration", Float32, timeDurationCallback)
  rospy.Subscriber("/ugv/runtime", Float32, runTimeCallback)
  rospy.Subscriber("/ugv/explored_volume", Float32, exploredVolumeCallback)
  rospy.Subscriber("/ugv/traveling_distance", Float32, travelingDistanceCallback)
