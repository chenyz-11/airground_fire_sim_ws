...
int main(int argc, char** argv)
{
  ...
  ros::Subscriber subOdom = nh.subscribe<nav_msgs::Odometry> ("/ugv/state_estimation", 5, odomHandler);

  ros::Subscriber subPath = nh.subscribe<nav_msgs::Path> ("/ugv/path", 5, pathHandler);
  ...
  ros::Publisher pubSpeed = nh.advertise<geometry_msgs::TwistStamped> ("/ugv/cmd_vel", 5);
